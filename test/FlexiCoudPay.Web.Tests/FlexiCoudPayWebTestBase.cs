...
{
    public abstract class FlexiCoudPayWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static FlexiCoudPayWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(FlexiCoudPayWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<FlexiCoudPayDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<FlexiCoudPayDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<FlexiCoudPayDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<FlexiCoudPayDbContext, Task<T>> func)
        {
            T result;
