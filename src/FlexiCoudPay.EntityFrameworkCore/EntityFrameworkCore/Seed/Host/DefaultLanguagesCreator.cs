...
namespace FlexiCoudPay.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        ...
        {
            var tenantId = FlexiCoudPayConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
        ...
        public DefaultLanguagesCreator(FlexiCoudPayDbContext context)
        {
            _context = context;
        }
