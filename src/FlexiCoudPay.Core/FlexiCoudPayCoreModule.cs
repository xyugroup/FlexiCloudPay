...
namespace FlexiCoudPay
{
    ...
    public class FlexiCoudPayCoreModule : AbpModule
    {
        public override void PreInitialize()
        {
            ...
            FlexiCoudPayLocalizationConfigurer.Configure(Configuration.Localization);

            // Enable this line to create a multi-tenant application.
            Configuration.MultiTenancy.IsEnabled = FlexiCoudPayConsts.MultiTenancyEnabled;
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(FlexiCoudPayCoreModule).GetAssembly());
        }
