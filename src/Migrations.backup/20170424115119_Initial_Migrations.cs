    ...
    public partial class Initial_Migrations : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            */
            ...
            migrationBuilder.Sql("CREATE INDEX `IX_AbpRoleClaims_TenantId_ClaimType` ON `AbpRoleClaims` (`TenantId`, `ClaimType`(250));");
            ...
            */
            ...
            migrationBuilder.Sql(" CREATE INDEX `IX_AbpUserAccounts_TenantId_EmailAddress` ON `AbpUserAccounts` (`TenantId`, `EmailAddress`(250));");
            ...
            */
            ...
            migrationBuilder.Sql("CREATE INDEX `IX_AbpUserAccounts_TenantId_UserName` ON `AbpUserAccounts` (`TenantId`, `UserName`(250));");
            ...
            */
            ...
            migrationBuilder.Sql("CREATE INDEX `IX_AbpUserClaims_TenantId_ClaimType` ON `AbpUserClaims` (`TenantId`, `ClaimType`(100));");
            ...
            */
            ...
            migrationBuilder.Sql("CREATE INDEX `IX_AbpUserLogins_TenantId_LoginProvider_ProviderKey` ON `AbpUserLogins` (`TenantId`, `LoginProvider`(50), `ProviderKey`(100));");
            ...
            */
            ...
            migrationBuilder.Sql("CREATE INDEX `IX_AbpLanguageTexts_TenantId_Source_LanguageName_Key` ON `AbpLanguageTexts` (`TenantId`, `Source`(100), `LanguageName`(50), `Key`(50));");
